...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.spacer:
      ...
      return format('<table class="%s" role="presentation"><tbody><tr><td data-embed height="'+size+'px" style="font-size:'+size+'px;line-height:'+size+'px;">&#xA0;</td></tr></tbody></table>', classes.join(' '), inner);
